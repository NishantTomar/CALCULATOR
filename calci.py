...
label1.config(bg = 'grey',font=('new roman',20,'bold'))
...
def equalto():
    ...
    if (ind == 1):
        labels.config(text='indeterminent')
    else:
        labels.config(text=expression)
        expression = ''
...
buttonadd.grid(row=3,column = 3,padx=5,pady=5,ipadx=5,ipady=5)
...
buttonsub.grid(row=4,column = 3,padx=5,pady=5,ipadx=5,ipady=5)
...
buttonmul.grid(row=5,column = 3,padx=5,pady=5,ipadx=5,ipady=5)

button0 = tk.Button(mainWindow,text = '0',height = 2, width = 5,command = lambda:printNo(0))
button0.grid(row=6,column = 0,padx=5,pady=5,ipadx=5,ipady=5)
buttonc = tk.Button(mainWindow,text = '=',height = 2, width = 5, command = lambda:equalto() )
buttonc.grid(row=6, column= 1, padx=5,pady=5,ipadx=5,ipady=5)
buttonac = tk.Button(mainWindow,text = 'A/C',height = 2, width = 5, command = lambda:allclear() )
buttonac.grid(row=6, column= 2, padx=5,pady=5,ipadx=5,ipady=5)
buttondiv = tk.Button(mainWindow,text = '/',height = 2, width = 5,command= lambda: asciconvert('/'))
buttondiv.grid(row=6,column = 3,padx=5,pady=5,ipadx=5,ipady=5)
